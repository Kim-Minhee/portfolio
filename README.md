...
- **AI / ML:** PyTorch, TensorFlow(Keras), Ultralytics(YOLO), EfficientNet
- **Generative AI:** Google Gemini API, Prompt Engineering
- **Web / Backend:** Streamlit, Spring(Java)
- **Data Analysis:** Pandas, NumPy, PyCaret


## 💼 Work Experience
* **웹개발/딥러닝팀** (9개월)
  - 반려견 감정 및 소음 음성 분류 AI 모델 성능 개선
  - 근태 솔루션 등 Java 기반 웹 백엔드 로직 개발
* **바이오AI팀** (3개월)
  - EfficientNet을 활용한 검사지 스캔 이미지 분류 모델 개발
  - LSTM 및 ML(PyCaret)을 이용한 특징 기반 점수 예측 모델 개발
* **QC팀** (15개월)
  - 원부자재 및 제품 품질 검사/관리
  - 이상 데이터 원인 분석
...
## 🎓 Education & Training
* **생성형 AI 활용 개발자 과정** (2026.04 ~, 수강 중)
* **생성 AI 응용 서비스 개발자 과정** (2024.08 ~ 2025.03, 수료)
* **AI 헬스케어 비즈니스 모델 개발, AI 헬스케어 데이터 정제 및 가공** (2023.08 ~ 2023.09, 수료)
* **파이썬 기반 빅데이터 시각화 과정** (2022.05 ~ 2022.07, 수료)
* **Java 빅데이터 UI기반 웹개발자 과정** (2020.05 ~ 2020.11, 수료)
